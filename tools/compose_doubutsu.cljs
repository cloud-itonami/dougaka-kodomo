...
(def animals
  [{:name ["いぬ"   [["い" 67 0.75] ["ぬ" 67 0.75]]]
   ...
   {:name ["うし"   [["う" 67 0.75] ["し" 67 0.75]]]
    ;; VOICEVOX の sing score は長音記号「ー」を単独 mora として受理しない
    ;; (400 lyricが不正です) — 前mora の母音("も"→お)を繰り返して表音する。
    :sound ["もー"   [["も" 64 0.75] ["お" 62 1.5]]]}
   {:name ["ぶた"   [["ぶ" 67 0.75] ["た" 67 0.75]]]
    :sound ["ぶーぶー" [["ぶ" 67 0.5] ["う" 62 0.5] ["ぶ" 64 0.5] ["う" 62 1.0]]]}
